...
#' @param p Proportion of outliers to add to \code{x}. In case \code{x} is a
#' \code{data.frame}, \code{p} can also be a vector of probabilities per column or a
#' named vector (see examples).
